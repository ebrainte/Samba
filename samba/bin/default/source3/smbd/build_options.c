...
void build_options(bool screen)
{
	...
	/* Show System Headers */
       ...
       output(screen, "   HAVE_SYS_STROPTS_H\n");
#endif
	...
	/* Show HAVE_* Defines */
...
#endif
#ifdef HAVE_COM_RIGHT_R
       output(screen, "   HAVE_COM_RIGHT_R\n");
#endif
#ifdef HAVE_CONNECT
...
#endif
#ifdef HAVE_GETPASS
       output(screen, "   HAVE_GETPASS\n");
#endif
#ifdef HAVE_GETPASSPHRASE
       output(screen, "   HAVE_GETPASSPHRASE\n");
#endif
       ...
       output(screen, "   HAVE_LIBGCRYPT\n");
#endif
#ifdef HAVE_LIBGNUTLS
       output(screen, "   HAVE_LIBGNUTLS\n");
#endif
#ifdef HAVE_LIBGPG_ERROR
       output(screen, "   HAVE_LIBGPG_ERROR\n");
#endif
#ifdef HAVE_LIBKRB5
...
#endif
#ifdef USING_SYSTEM_COM_ERR
       output(screen, "   USING_SYSTEM_COM_ERR\n");
#endif
