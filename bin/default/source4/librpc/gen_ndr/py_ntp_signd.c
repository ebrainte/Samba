...
static PyMethodDef py_sign_request_methods[] = {
	...
	{ "__ndr_print__", (PyCFunction)py_sign_request_ndr_print, METH_VARARGS, "S.ndr_print(object) -> None\nNDR print" },
	{ NULL, NULL, 0, NULL }
};
...
static PyMethodDef py_signed_reply_methods[] = {
	...
	{ "__ndr_print__", (PyCFunction)py_signed_reply_ndr_print, METH_VARARGS, "S.ndr_print(object) -> None\nNDR print" },
	{ NULL, NULL, 0, NULL }
};
